...
/////////////////
const BotName = 'BOT'; 
const instagram = 'https://instagram.com/grptr4'; 
const telegram = 'https://t.me/putra'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/Gerarputra';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@grptr4')
